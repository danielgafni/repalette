...
S3_MODEL_CHECKPOINTS_DIR = os.path.join(S3_BUCKET_PATH, S3_MODEL_CHECKPOINTS_RELATIVE_DIR)
...
DISCORD_TRAINING_CHANNEL_ID = int(os.getenv("DISCORD_TRAINING_CHANNEL_ID"))
